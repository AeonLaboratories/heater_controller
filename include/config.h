...
///////////////////////////////////////////////////////
// Several performance optimizations are possible if 
// certain values are integral factors of others 
// and/or are powers of 2. However, constructs that 
// depend on these properties can otherwise break the 
// code.
//
// Preprocessor conditional expressions cannot contain 
// non-integral values. Consequently, there is apparently 
// no way to test whether an expression *is* non-integer;
// upon encountering any such test, the preprocessor 
// simply dies with the error "Illegal constant expression."
//
...
// conditions are met, othewise, to 0 (false):
//
/*
...
#define CU_PERIOD_IPOT						0
#define SERVICE_PERIOD_IPOT					0
